...
// while (!compareCoord(boatOne, boatTwo) && !compareCoord(boatTwo, boatThree) && !compareCoord(boatTwo, boatFour)) {
//     boatTwo = Math.floor(Math.random() * 6);   
// }
// while (!compareCoord(boatOne, boatThree) && !compareCoord(boatThree, boatFour)) {
//     boatThree = Math.floor(Math.random() * 6);
// }
// while (!compareCoord(boatOne, boatFour)) {
//     boatFour = Math.floor(Math.random() * 6);
// }
